...
const members:any = [
	"assets/img/avatars/thumb-1.jpg",
	"assets/img/avatars/thumb-2.jpg",
	"assets/img/avatars/thumb-3.jpg",
	"assets/img/avatars/thumb-4.jpg",
	"assets/img/avatars/thumb-5.jpg",
	"assets/img/avatars/thumb-6.jpg",
]
const data:any = [];
const columns:any = [];
